...
# https://dreamwiki.tistory.com
blog_name = 'dreamwiki'  # 티스토리 블로그 이름
...
if __name__ == '__main__':
    ...
    post_blog_by_keyword(keyword='Successful investment method', count='3', expose=True, isKorean=False)
